...
|       梅凯   |    2020/06/29  |      最终完善酒店预定系统软件体系结构描述文档    |    v1.0.9    |
...
| 开发包 | 依赖的其他开发包               |
| :----: | ------------------------------ |
| mainui | adminui,hotelui,vo,clientui,po,hotelmanagerui,orderui|
| userui |   userblimpl                         |
| userbl | po,vo                        |
| userblimpl |         userbl,userdata,po,springframework,dataimpl                      |
|usercontroller  |     userbl,po                           |
| userdata |                 po,apache               |
| hotelmanagerui |     hotelmanagercontroller                          |
| couponbl |   po,vo  ,orderbl                             |
| couponblimpl |  couponbl,coupondata,po, springframework ,dataimpl                               |
| couponcontroller |          couponbl,vo                         |
| coupondata |         po,apache                       |
| hotelui |   hotelcontroller                        |
|  hotelbl|   po,vo ,oderbl,couponbl                              |
| hotelblimpl |       hotelbl，hoteldata po, springframework ,dataimpl                        |
| hotelcontroller |     hotelbl,vo                              |
|  hoteldata|       po,apache                         |
| adminui |  admincontroller                     |
|  adminbl| po,vo                              |
|  adminblimpl|     adminbl,admindata,po  , springframework ,dataimpl                        |
