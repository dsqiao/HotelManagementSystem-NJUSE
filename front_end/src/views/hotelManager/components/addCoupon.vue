            ...
            <a-tabs>
                <a-tab-pane tab="生日特惠" key="1">
                    ...
                    <div style="width: 100%; text-align: right; margin:20px 0">
                        <a-button type="primary" @click="setType(1)"
                            ><a-icon type="select" /> 确定</a-button
                        >
                    </div>
                </a-tab-pane>
                <a-tab-pane tab="多间优惠" key="2">
                    ...
                    <div style="width: 100%; text-align: right; margin:20px 0">
                        <a-button type="primary" @click="setType(2)"
                            ><a-icon type="select" />确定</a-button
                        >
                    </div>
                </a-tab-pane>
                <a-tab-pane tab="满减优惠" key="3">
                    ...
                    <div style="width: 100%; text-align: right; margin:20px 0">
                        <a-button type="primary" @click="setType(3)"
                            ><a-icon type="select" /> 确定</a-button
                        >
                    </div>
                </a-tab-pane>
                <a-tab-pane tab="限时优惠" key="4">
                    ...
                    <div style="width: 100%; text-align: right; margin:20px 0">
                        <a-button type="primary" @click="setType(4)"
                            ><a-icon type="select" /> 确定</a-button
                        >
                    </div>
                </a-tab-pane>
...
export default {
    ...
    computed: {
        ...mapGetters(['activeHotelId', 'addCouponVisible', 'type']),
    },
    beforeCreate() {
        // 表单名默认为“form”
    ...
    methods: {
        ...mapMutations(['set_addCouponVisible', 'set_type']),
        ...mapActions([
            ...
            this.form.validateFieldsAndScroll((err, values) => {
                if (!err) {
                    const data = {
                        ...
                        startTime: moment(
                            this.form.getFieldValue('startValue')
                        ).format('YYYY-MM-DD 00:00:00'),
                        endTime: moment(
                            this.form.getFieldValue('endValue')
                        ).format('YYYY-MM-DD 00:00:00'),
                    }
