...
export default {
    ...
    computed: {
        ...mapGetters(['addCoupon4Visible']),
    },
    methods: {
        ...mapActions(['addCoupon4']),
        ...mapMutations(['set_addCoupon4Visible']),
        cancel() {
            ...
            this.form.validateFieldsAndScroll((err, values) => {
                if (!err) {
                    const data = {
                        ...
                        hotelId: -1,
                        NumOfRoom: null,
                        startTime: moment(this.startValue).format(
                            'YYYY-MM-DD 12:00:00'
                        ),
                        endTime: moment(this.endValue).format(
                            'YYYY-MM-DD 12:00:00'
                        ),
                    }
