...
<!--                    <a-button type="primary" @click="addCoupon1">-->
<!--                        <a-icon type="plus"/>添加生日特惠-->
<!--                    </a-button>-->
<!--                </div>-->
<!--                <a-table-->
<!--                       :columns="column1"-->
<!--                       :data-source="websiteCoupon1List"-->
<!--                >-->
<!--               </a-table>-->
<!--            </a-tab-pane>-->
<!--            <a-tab-pane tab="多间特惠" key="2">-->
<!--                <div style="width: 100%; text-align: right; margin: 20px 0">-->
<!--                    <a-button type="primary" @click="addCoupon2">-->
<!--                        <a-icon type="plus"/>添加多间特惠-->
<!--                    </a-button>-->
<!--                </div>-->
<!--                <a-table-->
<!--                        :columns="column2"-->
<!--                        :data-source="websiteCoupon2List"-->
<!--                ></a-table>-->
<!--            </a-tab-pane>-->
            ...
            <a-tab-pane tab="限时特惠" key="4">
                ...
                <a-table
                        :columns="column4"
                        :data-source="websiteCoupon4List"
                >
...
<script>
    ...
    export default {
        components: {AddCoupon4Modal, AddCoupon3Modal, AddCoupon2Modal, AddCoupon1Modal},
        data() {
            return {
                column1,
                column2,
