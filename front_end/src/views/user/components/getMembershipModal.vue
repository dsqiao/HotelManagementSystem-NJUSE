                ...
                <a-tab-pane tab="普通会员" key="1">
                    <a-form-item v-bind="formItemLayout" label="会员类型">
                        <a-select
                            ...
                            placeholder="请选择会员类型"
                        >
                            <a-select-option :value="'普通会员'"
                                >普通会员</a-select-option
                            >
                            <a-select-option :value="'企业会员'" disabled
                                >企业会员</a-select-option
                            >
                        </a-select>
                    </a-form-item>
                ...
                <a-tab-pane tab="企业会员" key="2">
                    <a-form-item v-bind="formItemLayout" label="会员类型">
                        <a-select
                            ...
                            placeholder="请选择会员类型"
                        >
                            <a-select-option :value="'普通会员'" disabled
                                >普通会员</a-select-option
                            >
                            <a-select-option :value="'企业会员'"
                                >企业会员</a-select-option
                            >
                        </a-select>
                    </a-form-item>
...
export default {
    ...
    computed: {
        ...mapGetters(['getMembershipModalVisible']),
    },
    beforeCreate() {
        this.form = this.$form.createForm(this, { name: 'getMembershipModal' })
    },
    methods: {
        ...mapMutations(['set_getMembershipModalVisible']),
        ...mapActions(['beMember']),
        cancel() {
