    ...
    >
        <a-form :form="form" v-bind="formItemLayout">
            ...
            <a-form-item label="房型">
                <span>
                    <span v-if="currentOrder.roomType === 'BigBed'"
                        >大床房</span
                    >
                    <span v-if="currentOrder.roomType === 'DoubleBed'"
                        >双床房</span
                    >
                    <span v-if="currentOrder.roomType === 'Family'"
                        >家庭房</span
                    >
                    <span v-if="currentOrder.roomType === 'PresidentBed'"
                        >总统套房</span
                    >
                </span>
            </a-form-item>
...
export default {
    ...
    methods: {
        ...mapMutations(['set_orderDetailModalVisible']),
        ok: function() {
